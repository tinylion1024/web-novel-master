...
5. **基于大纲规划创作** — 严格按照大纲中本章的核心事件和爽点设计撰写正文
6. 撰写正文 — **每章必须达到 2000-3000 字**
...
7. **字数检查** — 必须使用脚本检查：`python scripts/check_chapter_wordcount.py <章节文件路径>`
...
12. 生成章节摘要 — 在 `00-大纲.md` 的章节摘要区追加（200-300字，保证连贯性参考）
