...
| 当前阶段 | 触发条件 | 下一阶段 | 返回阶段 |
|---------|---------|---------|---------|
| Phase 0 | 完成初始化 | Phase 1 或 Phase 2（跳过） | - |
| Phase 1 Layer1 | Q1-Q4 完成 | Phase 1 Layer2 | - |
| Phase 1 Layer2 | Q5-Q10 完成 + 确认 | Phase 2 | Phase 1 Layer1 |
| Phase 2 | 用户确认规划 | Phase 2.5 | Phase 1 Layer2 |
| Phase 2.5 | 用户选择写作模式 | Phase 3 | Phase 2 |
| Phase 3 | 所有章节完成 | Phase 4 | Phase 2.5 |
| Phase 4 | 校验通过或达到最大重试次数 | 完成 | Phase 3 |
